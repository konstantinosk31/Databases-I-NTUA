-- Created for the purposes of the Databases course in the Department of Electrical and Computer Engineering of the National Technical University of Athens

-- Authors:
-- 1. Kakos <sakakos> Sotirios
-- 2. Kritharidis <konstantinosk31> Konstantinos
-- 3. Minagias <minageus> Dimitrios

-- MySQL Script generated by MySQL Workbench
-- Sun May 26 16:18:38 2024
...
CREATE TABLE IF NOT EXISTS `mydb`.`Ingredients` (
  ...
  `Ingredients_Images` BLOB NULL DEFAULT NULL,
  PRIMARY KEY (`name`),
...
BEGIN
	SET NEW.year = ((NEW.episode_number - 1) DIV 10) + 1;
    SET NEW.episode_name = ((NEW.episode_number - 1) MOD 10) + 1;
END$$
