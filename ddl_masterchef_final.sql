...
CREATE TABLE IF NOT EXISTS `mydb`.`Has_specialisation` (
  ...
  INDEX `fk_National Cuisine_has_Cook_National Cuisine1_idx` (`National_Cuisine_name` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`assignment` (
  `Cook_name` VARCHAR(50) NULL,
  `Cook_surname` VARCHAR(50) NOT NULL,
  `Episode_episode_number` INT NOT NULL,
  `National_Cuisine_name` VARCHAR(50) NOT NULL,
  `Recipies_name` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`Cook_name`, `Cook_surname`, `Episode_episode_number`, `National_Cuisine_name`, `Recipies_name`),
  INDEX `fk_assignment_Episode1_idx` (`Episode_episode_number` ASC) VISIBLE,
  INDEX `fk_assignment_National Cuisine1_idx` (`National_Cuisine_name` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_assignment_Episode1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_assignment_National Cuisine1`
    FOREIGN KEY (`National_Cuisine_name`)
    REFERENCES `mydb`.`National_Cuisine` (`name`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mydb`.`eval_for` (
  ...
  PRIMARY KEY (`assignment_Cook_name`, `assignment_Cook_surname`, `assignment_Episode_episode_number`, `assignment_National_Cuisine_name`, `assignment_Recipies_name`, `Judges_Cook_name`, `Judges_Cook_surname`, `Judges_Episode_episode_number`),
  ...
  INDEX `fk_assignment_has_Judges_assignment1_idx` (`assignment_Cook_name` ASC, `assignment_Cook_surname` ASC, `assignment_Episode_episode_number` ASC, `assignment_National_Cuisine_name` ASC, `assignment_Recipies_name` ASC) INVISIBLE,
  CONSTRAINT `fk_asssignment_has_Judges_assignment1`
    FOREIGN KEY (`assignment_Cook_name` , `assignment_Cook_surname` , `assignment_Episode_episode_number` , `assignment_National_Cuisine_name` , `assignment_Recipies_name`)
    REFERENCES `mydb`.`assignment` (`Cook_name` , `Cook_surname` , `Episode_episode_number` , `National_Cuisine_name` , `Recipies_name`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
