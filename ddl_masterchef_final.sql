...
BEGIN
    ...
    WHILE p_Episode_episode_number <= 10 DO
        ...
        WHILE Episode_Assignment_number <= 10 DO
            ...
            ELSE
				SELECT concat(concat("invalid: ", p_Episode_episode_number), concat(p_Cook_name, p_Cook_surname)) AS DEBUG;
            END IF;
        END WHILE;
        SET Episode_Assignment_number = 1;
...
BEGIN
    ...
    read_loop: LOOP
        ...
        IF is_valid = 1 THEN
			#SELECT concat(concat("valid_cook_not_in_3_in_a_row for p_Judge_name = ", p_Judge_name), concat(", p_Judge_surname", p_Judge_surname)) AS VALID_JUDGES;
...
BEGIN
	...
	SET p_Episode_episode_number = 1;
	WHILE p_Episode_episode_number <= 10 DO
		SELECT concat('inserting judges for episode ', p_Episode_episode_number) AS COMMENT;
