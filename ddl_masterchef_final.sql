...
CREATE TABLE IF NOT EXISTS `mydb`.`eval_for` (
  ...
  INDEX `fk_asssignment_has_Judges_assignment1_idx` (`assignment_Cook_name` ASC, `assignment_Cook_surname` ASC, `assignment_Episode_episode_number` ASC, `assignment_National_Cuisine_name` ASC, `assignment_Recipies_name` ASC) VISIBLE,
