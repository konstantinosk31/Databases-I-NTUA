...
BEGIN
    ...
    WHILE p_Episode_episode_number <= 100 DO
        ...
        WHERE name NOT IN
        (
			SELECT National_Cuisine_name
			FROM Assignment
			WHERE Episode_episode_number IN (p_Episode_episode_number-1, p_Episode_episode_number-2)
		)
        ORDER BY RAND()
        LIMIT 10;
        
        SELECT * FROM Temp_National_Cuisine;
